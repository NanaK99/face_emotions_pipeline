            ...
            if label != "0":
                if int(num_frames) > 0:
                    ...
                    while frame_idx < end*fps:
                        ...
                        # print("##########", one_up_down, both_up_down, lean_in_out)
                        one_shoulder_up_down = np.std(one_up_down)
                        both_shoulder_up_down = np.std(both_up_down)
                        # print("START, END", start, end)
                        # print("ONE",one_up_down, one_shoulder_up_down)
                        # print("BOTH", both_up_down,both_shoulder_up_down)
                        # print("LEAN IN OUT",lean_in_out, np.mean(lean_in_out) - np.median(lean_in_out))
